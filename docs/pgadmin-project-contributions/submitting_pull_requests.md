<a id="submitting_pull_requests"></a>
...
4. Review your changes and check them thoroughly to ensure they meet the
    pgAdmin [coding_standards](coding_standards.md), and review them against the
    [code_review](code_review.md) to minimise the chances of them being rejected.
...
!!! note
    ...
    This is a simple example of a workflow. You may choose to use other tools such as the [GitHub CLI](https://cli.github.com) instead; documenting such tools and workflows is outside the scope of the pgAdmin documentation however.
