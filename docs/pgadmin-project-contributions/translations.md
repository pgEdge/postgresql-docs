...
pgAdmin supports multiple languages using the [Flask-Babel](https://pythonhosted.org/Flask-Babel/) Python module. A list of supported languages is included in the **web/config.py** configuration file and must be updated whenever languages are added or removed with [ISO 639-1](https://en.wikipedia.org/wiki/ISO_639-1) (two letter) language codes. The codes are named **$LANG** in this document.
