...
AIO
:   [Asynchronous I/O](glossary.md#glossary-aio)

ACL
:   [Access Control List](https://en.wikipedia.org/wiki/Access-control_list)

AM
:   [Access Method](glossary.md#glossary-am)
...
BKI
:   [Backend Interface](../internals/system-catalog-declarations-and-initial-contents/index.md#bki)
...
CTE
:   [Common Table Expression](../the-sql-language/queries/with-queries-common-table-expressions.md#queries-with)
...
ECPG
:   [Embedded C for PostgreSQL](../client-interfaces/ecpg-embedded-sql-in-c/index.md#ecpg)
...
FSM
:   [Free Space Map](../internals/database-physical-storage/free-space-map.md#storage-fsm)

GEQO
:   [Genetic Query Optimizer](../internals/genetic-query-optimizer/index.md#geqo)

GIN
:   [Generalized Inverted Index](../internals/built-in-index-access-methods/gin-indexes.md#gin)

GiST
:   [Generalized Search Tree](../internals/built-in-index-access-methods/gist-indexes.md#gist)
...
GUC
:   [Grand Unified Configuration](../server-administration/server-configuration/setting-parameters.md#config-setting), the PostgreSQL subsystem that handles server configuration

HBA
:   [Host-Based Authentication](../server-administration/client-authentication/the-pg_hba-conf-file.md#auth-pg-hba-conf)

HOT
:   [Heap-Only Tuples](../internals/database-physical-storage/heap-only-tuples-hot.md#storage-hot)
...
I/O
:   [Input/Output](glossary.md#glossary-io)
...
MVCC
:   [Multi-Version Concurrency Control](../the-sql-language/concurrency-control/index.md#mvcc)
...
OID
:   [Object Identifier](../the-sql-language/data-types/object-identifier-types.md#datatype-oid)
...
PGXS
:   [PostgreSQL Extension System](../server-programming/extending-sql/extension-building-infrastructure.md#extend-pgxs)

PID
:   [Process Identifier](https://en.wikipedia.org/wiki/Process_identifier)

PITR
:   [Point-In-Time Recovery](../server-administration/backup-and-restore/continuous-archiving-and-point-in-time-recovery-pitr.md#continuous-archiving) (Continuous Archiving)

PL
:   [Procedural Languages (server-side)](../server-programming/index.md#server-programming)
...
SPI
:   [Server Programming Interface](../server-programming/server-programming-interface/index.md#spi)

SP-GiST
:   [Space-Partitioned Generalized Search Tree](../internals/built-in-index-access-methods/sp-gist-indexes.md#spgist)
...
TID
:   [Tuple Identifier](../the-sql-language/data-types/object-identifier-types.md#datatype-oid)

TLS
:   [Transport Layer Security](https://en.wikipedia.org/wiki/Transport_Layer_Security)

TOAST
:   [The Oversized-Attribute Storage Technique](../internals/database-physical-storage/toast.md#storage-toast)
...
UUID
:   [Universally Unique Identifier](../the-sql-language/data-types/uuid-type.md#datatype-uuid)

WAL
:   [Write-Ahead Log](../server-administration/reliability-and-the-write-ahead-log/index.md#wal)

XID
:   [Transaction Identifier](../the-sql-language/data-types/object-identifier-types.md#datatype-oid)
