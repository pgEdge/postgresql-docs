...
```
 ...
 For matching of single names, returned text arrays can be matched directly using the `&&` operator: any overlap can be considered a match. A GIN index may be used for efficiency, see [GIN Indexes](../../internals/gin-indexes/index.md#gin) and this example:
