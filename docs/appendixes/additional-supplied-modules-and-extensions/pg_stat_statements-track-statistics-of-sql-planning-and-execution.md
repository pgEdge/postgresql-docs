...
<p>Minimum time spent planning the statement, in milliseconds (if <code>pg_stat_statements.track_planning</code> is enabled, otherwise zero)</p></td>
</tr>
<tr>
<td><p><code>max_plan_time</code> <code>double precision</code></p>
<p>Maximum time spent planning the statement, in milliseconds (if <code>pg_stat_statements.track_planning</code> is enabled, otherwise zero)</p></td>
</tr>
<tr>
...
<p>Minimum time spent executing the statement, in milliseconds</p></td>
</tr>
<tr>
<td><p><code>max_exec_time</code> <code>double precision</code></p>
<p>Maximum time spent executing the statement, in milliseconds</p></td>
</tr>
<tr>
...
<p>Total time the statement spent reading data file blocks, in milliseconds (if <a href="../../server-administration/server-configuration/run-time-statistics.md#guc-track-io-timing">track_io_timing</a> is enabled, otherwise zero)</p></td>
</tr>
<tr>
<td><p><code>blk_write_time</code> <code>double precision</code></p>
<p>Total time the statement spent writing data file blocks, in milliseconds (if <a href="../../server-administration/server-configuration/run-time-statistics.md#guc-track-io-timing">track_io_timing</a> is enabled, otherwise zero)</p></td>
</tr>
<tr>
