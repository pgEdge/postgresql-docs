...
:   `bt_page_items` returns detailed information about all of the items on a B-tree index page. For example:
    ...
    ```
     ...
     For more details about the structure of B-tree indexes, see [B-Tree Structure](../../internals/b-tree-indexes/implementation.md#btree-structure). For more details about deduplication and posting lists, see [Deduplication](../../internals/b-tree-indexes/implementation.md#btree-deduplication).
