...
| `locker` | `xid` | Transaction ID of locker, or multixact ID if multitransaction; see [Transactions and Identifiers](../../internals/transaction-processing/transactions-and-identifiers.md#transaction-id) |
