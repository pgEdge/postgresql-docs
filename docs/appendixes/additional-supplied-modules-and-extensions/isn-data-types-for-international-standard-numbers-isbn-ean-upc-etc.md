...
<tbody>
<tr>
<td><code>make_valid</code> ( <code>isn</code> ) <code>isn</code></td>
<td>Clears the invalid-check-digit flag of the value.</td>
<td></td>
</tr>
<tr>
<td><code>is_valid</code> ( <code>isn</code> ) <code>boolean</code></td>
<td>Checks for the presence of the invalid-check-digit flag.</td>
<td></td>
</tr>
<tr>
<td><code>isn_weak</code> ( <code>boolean</code> ) <code>boolean</code></td>
<td>Sets the weak input mode, and returns the new setting. This function is retained for backward compatibility. The recommended way to set weak mode is via the <code>isn.weak</code> configuration parameter.</td>
<td></td>
</tr>
<tr>
<td><code>isn_weak</code> () <code>boolean</code></td>
<td>Returns the current status of the weak mode. This function is retained for backward compatibility. The recommended way to check weak mode is via the <code>isn.weak</code> configuration parameter.</td>
<td></td>
</tr>
</tbody>
</table>
...
- [https://en.wikipedia.org/wiki/List_of_ISBN_registration_groups](https://en.wikipedia.org/wiki/List_of_ISBN_registration_groups)
- [https://www.isbn-international.org/content/isbn-users-manual/29](https://www.isbn-international.org/content/isbn-users-manual/29)
