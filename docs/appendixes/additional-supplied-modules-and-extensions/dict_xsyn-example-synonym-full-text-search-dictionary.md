...
-----------------------
 {word}
```
 Real-world usage will involve including it in a text search configuration as described in [Full Text Search](../../the-sql-language/full-text-search/index.md#textsearch). That might look like this:
