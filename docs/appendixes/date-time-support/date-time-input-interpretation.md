...
1.  See if the token matches any known time zone abbreviation. These abbreviations are supplied by the configuration file described in [Date/Time Configuration Files](date-time-configuration-files.md#datetime-config-files).
