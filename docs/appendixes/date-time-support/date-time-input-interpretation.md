...
1.  See if the token matches any known time zone abbreviation. These abbreviations are determined by the configuration settings described in [Date/Time Configuration Files](date-time-configuration-files.md#datetime-config-files).
