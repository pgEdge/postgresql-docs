...
## The Connection Service File
 ...
 Either service file uses an “INI file” format where the section name is the service name and the parameters are connection parameters; see [Parameter Key Words](database-connection-control-functions.md#libpq-paramkeywords) for a list. For example:
