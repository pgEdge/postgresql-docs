...
```
 ...
 If a query is expected to return more than one result row, a cursor should be used, as in the following example. (See [Using Cursors](running-sql-commands.md#ecpg-cursors) for more details about the cursor.)
