...
## Localization
 ...
 Keep in mind that error message texts need to be translated into other languages. Follow the guidelines in [Message-Writing Guidelines](../native-language-support/for-the-programmer.md#nls-guidelines) to avoid making life difficult for translators.
