...
<p>Type of object this entry is for: <code>r</code> = relation (table, view), <code>S</code> = sequence, <code>f</code> = function, <code>T</code> = type, <code>n</code> = schema, <code>L</code> = large object</p></td>
</tr>
<tr>
