...
<p>A histogram of the lengths of non-empty and non-null range values of an expression. (Null for non-range types.)</p>
...
<p>Fraction of expression entries whose values are empty ranges. (Null for non-range types.)</p></td>
</tr>
<tr>
