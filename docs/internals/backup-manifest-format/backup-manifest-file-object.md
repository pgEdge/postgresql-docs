...
`Last-Modified`
:   The last modification time of the file as reported by the server at the time of the backup. Unlike the other fields stored in the backup, this field is not used by [app-pgverifybackup](../../reference/postgresql-client-applications/pg_verifybackup.md#app-pgverifybackup). It is included only for informational purposes.
