...
# Table Access Method Interface Definition
 ...
 For crash safety, an AM can use postgres' [WAL](../server-administration/reliability-and-the-write-ahead-log/index.md#wal), or a custom implementation. If WAL is chosen, either [Generic WAL Records](generic-wal-records.md#generic-wal) can be used, or a [Custom WAL Resource Manager](custom-wal-resource-managers.md#custom-rmgr) can be implemented.
