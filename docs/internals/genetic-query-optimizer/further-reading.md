...
-  [Fundamentals of Database Systems](../../bibliography.md#elma04)
-  [[The design and implementation of the POSTGRES query optimizer](https://dsf.berkeley.edu/papers/UCB-MS-zfong.pdf)](../../bibliography.md#fong)
