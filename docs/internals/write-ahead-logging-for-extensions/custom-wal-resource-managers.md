...
## Custom WAL Resource Managers
 ...
 An extension, especially a [Table Access Method](../table-access-method-interface-definition.md#tableam) or [Index Access Method](../index-access-method-interface-definition/index.md#indexam), may need to use WAL for recovery, replication, and/or [Logical Decoding](../../server-programming/logical-decoding/index.md#logicaldecoding).
