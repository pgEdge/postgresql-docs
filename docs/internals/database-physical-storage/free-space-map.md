...
## Free Space Map
 ...
 See `src/backend/storage/freespace/README` for more details on how the FSM is structured, and how it's updated and searched. The [pg_freespacemap](../../appendixes/additional-supplied-modules-and-extensions/pg_freespacemap-examine-the-free-space-map.md#pgfreespacemap) module can be used to examine the information stored in free space maps.
