...
<tr>
<td><code>array_reverse</code> ( <code>anyarray</code> ) <code>anyarray</code></td>
<td>Reverses the first dimension of the array.</td>
<td><code>array_reverse(ARRAY[[1,2],[3,4],[5,6]])</code> <code>{{5,6},{3,4},{1,2}}</code></td>
</tr>
<tr>
...
<tr>
<td><code>array_sort</code> ( <code>array</code> <code>anyarray</code> [, <code>descending</code> <code>boolean</code> [, <code>nulls_first</code> <code>boolean</code> ]] ) <code>anyarray</code></td>
<td>Sorts the first dimension of the array. The sort order is determined by the default sort ordering of the array's element type; however, if the element type is collatable, the collation to use can be specified by adding a <code>COLLATE</code> clause to the <code>array</code> argument.</td>
<td>If <code>descending</code> is true then sort in descending order, otherwise ascending order. If omitted, the default is ascending order. If <code>nulls_first</code> is true then nulls appear before non-null values, otherwise nulls appear after non-null values. If omitted, <code>nulls_first</code> is taken to have the same value as <code>descending</code>.<br><code>array_sort(ARRAY[[2,4],[2,1],[6,5]])</code> <code>{{2,1},{2,4},{6,5}}</code></td>
</tr>
<tr>
