...
```
 ...
 Here, *expression* represents any value expression that does not itself contain window function calls. Some non-aggregate functions allow a `null treatment` clause, described in [Window Functions](../functions-and-operators/window-functions.md#functions-window).
