...
1.  Select the functions to be considered from the `pg_proc` system catalog. If a non-schema-qualified function name was used, the functions considered are those with the matching name and argument count that are visible in the current search path (see [The Schema Search Path](../data-definition/schemas.md#ddl-schemas-path)). If a qualified function name was given, only functions in the specified schema are considered.
...
**Example: Rounding Function Argument Type Resolution**
...
**Example: Variadic Function Resolution**
...
**Example: Substring Function Type Resolution**
