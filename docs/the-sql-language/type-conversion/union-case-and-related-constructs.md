...
**Example: Type Resolution with Underspecified Types in a Union**
...
**Example: Type Resolution in a Simple Union**
...
**Example: Type Resolution in a Transposed Union**
...
**Example: Type Resolution in a Nested Union**
