...
| `word` | Word, all letters | `ma&ntilde;ana` |
| `numword` | Word, letters and digits | `beta1` |
| `asciihword` | Hyphenated word, all ASCII | `up-to-date` |
| `hword` | Hyphenated word, all letters | `l&oacute;gico-matem&aacute;tica` |
...
| `hword_part` | Hyphenated word part, all letters | `l&oacute;gico` or `matem&aacute;tica` in the context `l&oacute;gico-matem&aacute;tica` |
