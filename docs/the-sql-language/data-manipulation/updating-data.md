...
## Updating Data
 ...
 To update existing rows, use the [sql-update](../../reference/sql-commands/update.md#sql-update) command. This requires three pieces of information:
