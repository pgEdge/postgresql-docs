...
```
 See [sql-createtable](../../reference/sql-commands/create-table.md#sql-createtable) for more details.
...
```
 ...
 The data type of an identity column must be one of the data types supported by sequences. (See [sql-createsequence](../../reference/sql-commands/create-sequence.md#sql-createsequence).) The properties of the associated sequence may be specified when creating an identity column (see [sql-createtable](../../reference/sql-commands/create-table.md#sql-createtable)) or changed afterwards (see [sql-altertable](../../reference/sql-commands/alter-table.md#sql-altertable)).
