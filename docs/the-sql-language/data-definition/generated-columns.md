...
```
 The keyword `STORED` must be specified to choose the stored kind of generated column. See [sql-createtable](../../reference/sql-commands/create-table.md#sql-createtable) for more details.
