...
!!! note
    ...
    This section describes a PostgreSQL-specific way to create an autoincrementing column. Another way is to use the SQL-standard identity column feature, described at [sql-createtable](../../reference/sql-commands/create-table.md#sql-createtable).
