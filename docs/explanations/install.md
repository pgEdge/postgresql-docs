...
<a id="docker_cpu_contraint"></a>

### Docker Resource Constraints

PostgREST does not support `--cpus` [constraint option](https://docs.docker.com/engine/containers/resource_constraints/#configure-the-default-cfs-scheduler).

As a workaround, you may use the [GHC RTS](https://ghc.gitlab.haskell.org/ghc/doc/users_guide/runtime_control.html#runtime-system-rts-options) `-N` option. For instance, to limit it to 2 CPU cores, do:
