...
- The minimum password length is set by default to six characters. This value
    ...
    in pgAdmin configuration; see [The config.py File](../getting-started/deployment/config_py.md#config_py) for more information.
...
![Change database password dialog](../images/password.png)
