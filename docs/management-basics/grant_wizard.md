...
![Grant wizard step one page](../images/grant_wizard_step1.png)
...
![Grant wizard step two page](../images/grant_wizard_step2.png)
...
For more information about granting privileges on database objects, see the [PostgreSQL core documentation](https://www.postgresql.org/docs/current/sql-grant.html).
...
![Grant wizard step three page](../images/grant_wizard_step3.png)
