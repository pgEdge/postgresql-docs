...
pgAdmin will run the maintenance process in the background. You can view all the background processes with their running status and logs on the [Processes](../processes.md#processes) tab.
