...
- Click the *Add New Server* button to open the
    [Register - Server dialog](../connecting-to-a-server/server_dialog.md#server_dialog) to add a new server definition.

- Click the *Configure pgAdmin* button to open the
    [Preferences dialog](preferences.md#preferences) to customize your pgAdmin client.
