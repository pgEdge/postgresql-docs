...
| Open Documentation in Default Browser | Boolean | By checking this option, all documentation links will open in the default browser instead of in a new window. |
