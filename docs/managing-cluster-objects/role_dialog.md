...
![Role dialog general tab](images/role_general.png)
...
![Role dialog definition tab](images/role_definition.png)
...
![Role dialog privileges tab](images/role_privileges.png)
...
![Role dialog membership tab](images/role_membership.png)

Use the *Membership* tab to define role memberships. A role can be a member of other roles and can have other roles as members.
...
Click the *Add* icon (+) to add more roles; to discard a role, click the trash icon to the left of the row and confirm the deletion in the *Delete Row* popup.
...
![Role dialog parameters tab](images/role_parameters.png)
...
![Role dialog security tab](images/role_security.png)
...
![Role dialog sql tab](images/role_sql.png)
