...
Multiple repositories may be configured as demonstrated in [S3 Support](s3-support.md#s3-support). A potential benefit is the ability to have a local repository for fast restores and a remote repository for redundancy.
