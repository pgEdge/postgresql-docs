...
![Type dialog general tab](../images/type_general.png)
...
![Type dialog composite section](../images/type_composite.png)
...
![Type dialog enumeration section](../images/type_enumeration.png)
...
![Type dialog external section](../images/type_external.png)
...
![Type dialog range section](../images/type_range.png)
...
![Type dialog shell section](../images/type_shell.png)

A shell type is a placeholder for a type and has no parameters.

Click the *Security* tab to continue.

![Type dialog security tab](../images/type_security.png)
...
![Type dialog sql tab](../images/type_sql.png)
