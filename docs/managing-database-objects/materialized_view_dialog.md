<a id="materialized_view_dialog"></a>
...
The *Materialized View* dialog organizes the development of a materialized_view through the following dialog tabs: *General*, *Definition*, *Code*, *Parameter*, and *Security*. The *SQL* tab displays the SQL code generated by dialog selections.

![Materialized view dialog general tab](../images/materialized_view_general.png)
...
![Materialized view dialog definition tab](../images/materialized_view_definition.png)
...
![Materialized view dialog code tab](../images/materialized_view_code.png)
...
![Materialized view dialog parameter tab](../images/materialized_view_parameter.png)
...
![Materialized view dialog security tab](../images/materialized_view_security.png)
...
![Materialized view dialog sql tab](../images/materialized_view_sql.png)
