...
![Function dialog general tab](images/function_general.png)
...
![Function dialog definition tab](images/function_definition.png)
...
![Function dialog code tab](images/function_code.png)
...
![Function dialog options tab](images/function_options.png)
...
![Function dialog parameters tab](images/function_parameters.png)
...
![Function dialog security tab](images/function_security.png)
...
![Function dialog sql tab](images/function_sql.png)

The example demonstrates creating a *plpgsql* function named *hire_salesmen*. The function has three columns (p_ename, p_sal and p_comm).
