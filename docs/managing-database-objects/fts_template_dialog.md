...
![FTS template dialog general tab](../images/fts_template_general.png)
...
![FTS template dialog definition tab](../images/fts_template_definition.png)
...
![FTS template dialog sql tab](../images/fts_template_sql.png)
