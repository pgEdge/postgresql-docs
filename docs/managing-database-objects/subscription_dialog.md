...
![Subscription dialog general tab](images/subscription_general.png)
...
![Subscription dialog connection tab](images/subscription_connection.png)
...
- Use the *Passfile* field to specify the location of a password file (.pgpass). A .pgpass file allows a user to login without providing a password when they connect.  For more information, see [Section 33.15 of the Postgres documentation](https://www.postgresql.org/docs/current/libpq-pgpass.html).
...
![Subscription dialog ssl tab](images/subscription_ssl.png)
...
![Subscription dialog with tab](images/subscription_with_1.png)
![Subscription dialog with tab](images/subscription_with_2.png)
...
![Subscription dialog sql tab](images/subscription_sql.png)
