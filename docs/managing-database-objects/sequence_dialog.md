...
![Sequence dialog general tab](../images/sequence_general.png)
...
![Sequence dialog definition tab](../images/sequence_definition.png)
...
![Sequence dialog security tab](../images/sequence_security.png)
...
Your entries in the *Sequence* dialog generate a SQL command (see an example below). Use the *SQL* tab for review; revisit or switch tabs to make any changes to the SQL command.

# Example

The following is an example of the sql command generated by user selections in the *Sequence* dialog:

![Sequence dialog sql tab](../images/sequence_sql.png)
