...
![View dialog general tab](../images/view_general.png)
...
![View dialog definition tab](../images/view_definition.png)
...
![View dialog code tab](../images/view_code.png)

Use the workspace in the *Code* tab to write a query to create a view.

Click the *Security* tab to continue.

![View dialog security tab](../images/view_security.png)
...
![View dialog sql tab](../images/view_sql.png)
