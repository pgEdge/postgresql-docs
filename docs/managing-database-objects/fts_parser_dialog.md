...
![FTS parser dialog general tab](images/fts_parser_general.png)
...
![FTS parser dialog definition tab](images/fts_parser_definition.png)
...
![FTS parser dialog sql tab](images/fts_parser_sql.png)
