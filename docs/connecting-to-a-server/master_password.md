...
!!! note
    ...
    pgAdmin aims to be **secure by default**, however, you can disable the master password by setting the configuration parameter *MASTER_PASSWORD_REQUIRED=False*. See [The config.py File](../getting-started/deployment/config_py.md#config_py) for more information on configuration parameters and how they can be changed or enforced across an organisation.
