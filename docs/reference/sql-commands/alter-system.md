...
## Notes
 ...
 This command can't be used to set [data_directory](../../server-administration/server-configuration/file-locations.md#guc-data-directory), nor parameters that are not allowed in `postgresql.conf` (e.g., [preset options](../../server-administration/server-configuration/preset-options.md#runtime-config-preset)).
