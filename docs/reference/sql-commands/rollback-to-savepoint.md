...
## Notes
 ...
 Use [`RELEASE SAVEPOINT`](release-savepoint.md#sql-release-savepoint) to destroy a savepoint without discarding the effects of commands executed after it was established.
...
## See Also
  [sql-begin](begin.md#sql-begin), [sql-commit](commit.md#sql-commit), [sql-release-savepoint](release-savepoint.md#sql-release-savepoint), [sql-rollback](rollback.md#sql-rollback), [sql-savepoint](savepoint.md#sql-savepoint)
