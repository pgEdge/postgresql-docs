...
## Description
 ...
 Refer to [Interfacing Extensions to Indexes](../../server-programming/extending-sql/interfacing-extensions-to-indexes.md#xindex) for further information.
...
## Examples
 ...
 The following example command defines a GiST index operator class for the data type `_int4` (array of `int4`). See the [intarray](../../appendixes/additional-supplied-modules-and-extensions/intarray-manipulate-arrays-of-integers.md#intarray) module for the complete example.
...
## See Also
  [sql-alteropclass](alter-operator-class.md#sql-alteropclass), [sql-dropopclass](drop-operator-class.md#sql-dropopclass), [sql-createopfamily](create-operator-family.md#sql-createopfamily), [sql-alteropfamily](alter-operator-family.md#sql-alteropfamily)
