...
-  The symbol `=>` is reserved by the SQL grammar, so it cannot be used as an operator name.
 ...
 The other clauses specify optional operator optimization attributes. Their meaning is detailed in [Operator Optimization Information](../../server-programming/extending-sql/operator-optimization-information.md#xoper-optimization).
