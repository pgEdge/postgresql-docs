...
## See Also
  [sql-alteropfamily](alter-operator-family.md#sql-alteropfamily), [sql-dropopfamily](drop-operator-family.md#sql-dropopfamily), [sql-createopclass](create-operator-class.md#sql-createopclass), [sql-alteropclass](alter-operator-class.md#sql-alteropclass), [sql-dropopclass](drop-operator-class.md#sql-dropopclass)
