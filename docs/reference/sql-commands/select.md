...
```
 ...
 For more information on each row-level lock mode, refer to [Row-Level Locks](../../the-sql-language/concurrency-control/explicit-locking.md#locking-rows).
