...
## Description
 ...
 If the foreign data wrapper *fdw_name* is specified with a `CONNECTION` clause, then [sql-createsubscription](create-subscription.md#sql-createsubscription) may use this foreign server for connection information.
