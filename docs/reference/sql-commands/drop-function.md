...
`CASCADE`
:   Automatically drop objects that depend on the function (such as operators or triggers), and in turn all objects that depend on those objects (see [Dependency Tracking](../../the-sql-language/data-definition/dependency-tracking.md#ddl-depend)).
...
## See Also
  [sql-createfunction](create-function.md#sql-createfunction), [sql-alterfunction](alter-function.md#sql-alterfunction), [sql-dropprocedure](drop-procedure.md#sql-dropprocedure), [sql-droproutine](drop-routine.md#sql-droproutine)
