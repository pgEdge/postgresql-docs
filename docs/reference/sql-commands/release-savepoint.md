...
## Notes
 ...
 It is not possible to release a savepoint when the transaction is in an aborted state; to do that, use [sql-rollback-to](rollback-to-savepoint.md#sql-rollback-to).
...
## See Also
  [sql-begin](begin.md#sql-begin), [sql-commit](commit.md#sql-commit), [sql-rollback](rollback.md#sql-rollback), [sql-rollback-to](rollback-to-savepoint.md#sql-rollback-to), [sql-savepoint](savepoint.md#sql-savepoint)
