...
:   Name of a settable run-time parameter. Available parameters are documented in [Server Configuration](../../server-administration/server-configuration/index.md#runtime-config) and below.
...
`NAMES`
:   <code>SET NAMES </code><em>value</em> is an alias for <code>SET client_encoding TO </code><em>value</em>.
