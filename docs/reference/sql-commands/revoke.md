...
## Description
 ...
 See the description of the [`GRANT`](grant.md#sql-grant) command for the meaning of the privilege types.
...
## See Also
  [sql-grant](grant.md#sql-grant), [sql-alterdefaultprivileges](alter-default-privileges.md#sql-alterdefaultprivileges)
