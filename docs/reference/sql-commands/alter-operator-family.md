...
## See Also
  [sql-createopfamily](create-operator-family.md#sql-createopfamily), [sql-dropopfamily](drop-operator-family.md#sql-dropopfamily), [sql-createopclass](create-operator-class.md#sql-createopclass), [sql-alteropclass](alter-operator-class.md#sql-alteropclass), [sql-dropopclass](drop-operator-class.md#sql-dropopclass)
