...
:   An argument expression for the procedure call.
     ...
     Arguments can include parameter names, using the syntax <em>name</em><code> => </code><em>value</em>. This works the same as in ordinary function calls; see [Calling Functions](../../the-sql-language/sql-syntax/calling-functions.md#sql-syntax-calling-funcs) for details.
...
## Notes
 ...
 PL/pgSQL handles output parameters in `CALL` commands differently; see [Calling a Procedure](../../server-programming/pl-pgsql-sql-procedural-language/control-structures.md#plpgsql-statements-calling-procedure).
...
## See Also
  [sql-createprocedure](create-procedure.md#sql-createprocedure)
