...
`CASCADE`
:   Automatically drop objects that depend on the operator class (such as indexes), and in turn all objects that depend on those objects (see [Dependency Tracking](../../the-sql-language/data-definition/dependency-tracking.md#ddl-depend)).
...
## See Also
  [sql-alteropclass](alter-operator-class.md#sql-alteropclass), [sql-createopclass](create-operator-class.md#sql-createopclass), [sql-dropopfamily](drop-operator-family.md#sql-dropopfamily)
