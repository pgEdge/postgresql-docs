...
`CASCADE`
:   Automatically drop objects that depend on the operator family, and in turn all objects that depend on those objects (see [Dependency Tracking](../../the-sql-language/data-definition/dependency-tracking.md#ddl-depend)).
...
## See Also
  [sql-alteropfamily](alter-operator-family.md#sql-alteropfamily), [sql-createopfamily](create-operator-family.md#sql-createopfamily), [sql-alteropclass](alter-operator-class.md#sql-alteropclass), [sql-createopclass](create-operator-class.md#sql-createopclass), [sql-dropopclass](drop-operator-class.md#sql-dropopclass)
