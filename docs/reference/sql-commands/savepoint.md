...
## Notes
 ...
 Use [`ROLLBACK TO`](rollback-to-savepoint.md#sql-rollback-to) to rollback to a savepoint. Use [`RELEASE SAVEPOINT`](release-savepoint.md#sql-release-savepoint) to destroy a savepoint, keeping the effects of commands executed after it was established.
...
## See Also
  [sql-begin](begin.md#sql-begin), [sql-commit](commit.md#sql-commit), [sql-release-savepoint](release-savepoint.md#sql-release-savepoint), [sql-rollback](rollback.md#sql-rollback), [sql-rollback-to](rollback-to-savepoint.md#sql-rollback-to)
