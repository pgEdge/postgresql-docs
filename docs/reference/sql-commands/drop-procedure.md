...
`CASCADE`
:   Automatically drop objects that depend on the procedure, and in turn all objects that depend on those objects (see [Dependency Tracking](../../the-sql-language/data-definition/dependency-tracking.md#ddl-depend)).
...
## See Also
  [sql-createprocedure](create-procedure.md#sql-createprocedure), [sql-alterprocedure](alter-procedure.md#sql-alterprocedure), [sql-dropfunction](drop-function.md#sql-dropfunction), [sql-droproutine](drop-routine.md#sql-droproutine)
