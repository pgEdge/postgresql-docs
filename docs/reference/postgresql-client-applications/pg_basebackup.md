...
:   Sets checkpoint mode to fast (immediate) or spread (the default) (see [Making a Base Backup Using the Low Level API](../../server-administration/backup-and-restore/continuous-archiving-and-point-in-time-recovery-pitr.md#backup-lowlevel-base-backup)).
