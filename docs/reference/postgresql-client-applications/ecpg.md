...
## Description
 ...
 This reference page does not describe the embedded SQL language. See [ECPG — Embedded SQL in C](../../client-interfaces/ecpg-embedded-sql-in-c/index.md#ecpg) for more information on that topic.
...
<code>-C </code><em>mode</em>
:   Set a compatibility mode. *mode* can be `INFORMIX`, `INFORMIX_SE`, or `ORACLE`.

<code>-D </code><em>symbol</em><code>[=</code><em>value</em><code>]</code>
...
## Notes
 ...
 The value of either of these directories that is appropriate for the installation can be found out using [app-pgconfig](pg_config.md#app-pgconfig).
