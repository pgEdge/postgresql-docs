...
<code>-i </code><em>path</em>, <code>--ignore=</code><em>path</em>
...
<code>-m </code><em>path</em>, <code>--manifest-path=</code><em>path</em>
...
<code>-w </code><em>path</em>, <code>--wal-directory=</code><em>path</em>
