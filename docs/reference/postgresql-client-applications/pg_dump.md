...
## Description
 ...
 pg_dump only dumps a single database. To back up an entire cluster, or to back up global objects that are common to all databases in a cluster (such as roles and tablespaces), use [app-pg-dumpall](pg_dumpall.md#app-pg-dumpall).
