...
```
pg_resetwal [-f | --force] [-n | --dry-run] [OPTION...] {
     -D
     --pgdata
     | DATADIR}
```
...
*datadir*, <code>-D </code><em>datadir</em>, <code>--pgdata=</code><em>datadir</em>
...
<code>-c </code><em>xid</em><code>,</code><em>xid</em>, <code>--commit-timestamp-ids=</code><em>xid</em><code>,</code><em>xid</em>
...
<code>-e </code><em>xid_epoch</em>, <code>--epoch=</code><em>xid_epoch</em>
...
<code>-l </code><em>walfile</em>, <code>--next-wal-file=</code><em>walfile</em>
...
<code>-m </code><em>mxid</em><code>,</code><em>mxid</em>, <code>--multixact-ids=</code><em>mxid</em><code>,</code><em>mxid</em>
...
<code>-o </code><em>oid</em>, <code>--next-oid=</code><em>oid</em>
...
<code>-O </code><em>mxoff</em>, <code>--multixact-offset=</code><em>mxoff</em>
...
<code>-u </code><em>xid</em>, <code>--oldest-transaction-id=</code><em>xid</em>
...
<code>-x </code><em>xid</em>, <code>--next-transaction-id=</code><em>xid</em>
...
<code>--char-signedness=</code><em>option</em>
...
<code>--wal-segsize=</code><em>wal_segment_size</em>
:   Set the new WAL segment size, in megabytes. The value must be set to a power of 2 between 1 and 1024 (megabytes). See the same option of [app-initdb](initdb.md#app-initdb) for more information.
...
## See Also
  [app-pgcontroldata](pg_controldata.md#app-pgcontroldata)
