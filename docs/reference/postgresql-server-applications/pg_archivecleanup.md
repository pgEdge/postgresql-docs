...
:   Remove backup history files as well. See [Making a Base Backup](../../server-administration/backup-and-restore/continuous-archiving-and-point-in-time-recovery-pitr.md#backup-base-backup) for details about backup history files.
...
<code>-x </code><em>extension</em>, <code>--strip-extension=</code><em>extension</em>
