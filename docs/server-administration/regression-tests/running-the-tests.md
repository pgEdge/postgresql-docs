...
```
 (This makes use of functionality provided by libpq; see [options](../../client-interfaces/libpq-c-library/database-connection-control-functions.md#libpq-connect-options) for details.)
