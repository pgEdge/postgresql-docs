...
!!! note
    ...
    When ident is specified for a local (non-TCP/IP) connection, peer authentication (see [Peer Authentication](peer-authentication.md#auth-peer)) will be used instead.
