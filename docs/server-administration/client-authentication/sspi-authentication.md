...
## SSPI Authentication
 ...
 When using Kerberos authentication, SSPI works the same way GSSAPI does; see [GSSAPI Authentication](gssapi-authentication.md#gssapi-auth) for details.
