...
-  Determine the effect of lock contention on overall database performance, as well as the extent to which contention varies with overall database traffic.
 Details of the `pg_locks` view appear in [`pg_locks`](../../internals/system-views/pg_locks.md#view-pg-locks). For more information on locking and managing concurrency with PostgreSQL, refer to [Concurrency Control](../../the-sql-language/concurrency-control/index.md#mvcc).
