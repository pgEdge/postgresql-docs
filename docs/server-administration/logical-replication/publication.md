...
### Replica Identity
 ...
 See [`ALTER TABLE...REPLICA IDENTITY`](../../reference/sql-commands/alter-table.md#sql-altertable-replica-identity) for details on how to set the replica identity.
