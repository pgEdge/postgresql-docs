...
## Column Lists
 ...
 Specifying a column list when the publication also publishes [`FOR TABLES IN SCHEMA`](../../reference/sql-commands/create-publication.md#sql-createpublication-for-tables-in-schema) is not supported.
