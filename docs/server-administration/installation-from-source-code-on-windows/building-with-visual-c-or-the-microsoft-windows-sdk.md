...
```
 For more information about the regression tests, see [Regression Tests](../regression-tests/index.md#regress).
...
```
 ...
 Additionally, the behavior of TAP tests can be controlled by a set of environment variables, see [Environment Variables](../regression-tests/tap-tests.md#regress-tap-vars).
