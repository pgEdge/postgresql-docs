...
![Backup globals dialog](../images/backup_globals_general.png)
...
pgAdmin will run the backup process in the background. You can view all the background processes with their running status and logs on the [Processes](../processes.md#processes) tab.
