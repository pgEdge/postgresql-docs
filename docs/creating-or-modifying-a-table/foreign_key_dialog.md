...
![Foreign key dialog general tab](images/foreign_key_general.png)
...
![Foreign key dialog definition tab](images/foreign_key_definition.png)
...
![Foreign key dialog columns tab](images/foreign_key_columns.png)
...
![Foreign key dialog action tab](images/foreign_key_action.png)
...
![Foreign key dialog sql tab](images/foreign_key_sql.png)
