...
![Table dialog general tab](images/table_general.png)
...
![Table dialog columns tab](images/table_columns.png)
...
![Table dialog constraints tab](images/table_constraints.png)
...
![Table dialog primary key constraint definition](images/primary_key_definition.png)
...
![Table dialog foreign key constrain](images/table_foreign_key.png)
...
![Table dialog foreign key constraint definition](images/foreign_key_definition.png)
...
![Table dialog foreign key constraint columns](images/foreign_key_columns.png)
...
![Table dialog foreign key constraint action](images/foreign_key_action.png)
...
![Table dialog check constraint](images/table_check.png)
...
![Table dialog check constraint definition](images/check_definition.png)
...
![Table dialog unique constraint](images/table_unique.png)
...
![Table dialog unique constraint definition](images/unique_constraint_definition.png)
...
![Table dialog exclude constraint](images/table_exclude.png)
...
![Table dialog exclusion constraint definition](images/exclusion_constraint_definition.png)
...
![Table dialog exclusion constraint columns](images/exclusion_constraint_columns.png)
...
![Table dialog advanced tab](images/table_advanced.png)
...
![Table dialog partition tab](images/table_partition.png)
...
![Table dialog partition tree](images/table_partition_tree.png)

Click the *Parameter* tab to continue.

![Table dialog parameter tab](images/table_parameter.png)
...
![Table dialog security tab](images/table_security.png)
...
![Table dialog sql tab](images/table_sql.png)
