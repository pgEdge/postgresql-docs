...
PostgREST supports [Media Type Handlers](../api/references/api/media_type_handlers.md#custom_media). With a bit of work, SOAP endpoints become possible.
...
Do not forget to refresh the [PostgREST schema cache](../references/schema_cache.md#schema_reloading).
...
- [Functions with a single unnamed parameter](../api/references/api/functions.md#function_single_unnamed)

- [Media Type Handlers](../api/references/api/media_type_handlers.md#custom_media). See [The "Any" Handler](../api/references/api/media_type_handlers.md#any_handler), if you need to support an `application/soap+xml` media type or if you want to respond with XML without sending a media type.

- [Nginx reverse proxy](../explanations/nginx.md#nginx)
