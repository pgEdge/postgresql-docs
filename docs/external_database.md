...
In order to prevent this, pgAdmin now supports storing user settings in an external database using the new 'CONFIG_DATABASE_URI' parameter in the [config.py](getting-started/deployment/config_py.md#config_py) file.
