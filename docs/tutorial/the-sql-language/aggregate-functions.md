...
```
 ...
 The `LIKE` operator does pattern matching and is explained in [Pattern Matching](../../the-sql-language/functions-and-operators/pattern-matching.md#functions-matching).
