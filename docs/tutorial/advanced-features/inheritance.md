...
!!! note
    ...
    Although inheritance is frequently useful, it has not been integrated with unique constraints or foreign keys, which limits its usefulness. See [Inheritance](../../the-sql-language/data-definition/inheritance.md#ddl-inherit) for more detail.
