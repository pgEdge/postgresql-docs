...
<a id="client_error_verbosity"></a>

## Client Error Verbosity

For HTTP clients, the error verbosity can be set via [client-error-verbosity](configuration.md#client-error-verbosity) config.
