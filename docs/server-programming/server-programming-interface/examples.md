...
```
 ...
 This is how you declare the function after having compiled it into a shared library (details are in [Compiling and Linking Dynamically-Loaded Functions](../extending-sql/c-language-functions.md#dfunc).):
