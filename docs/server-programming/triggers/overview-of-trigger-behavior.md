...
## Overview of Trigger Behavior
 ...
 Once a suitable trigger function has been created, the trigger is established with [sql-createtrigger](../../reference/sql-commands/create-trigger.md#sql-createtrigger). The same trigger function can be used for multiple triggers.
