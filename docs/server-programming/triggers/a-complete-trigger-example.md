...
```
 ...
 After you have compiled the source code (see [Compiling and Linking Dynamically-Loaded Functions](../extending-sql/c-language-functions.md#dfunc)), declare the function and the triggers:
...
```
 ...
 There are more complex examples in `src/test/regress/regress.c` and in [spi](../../appendixes/additional-supplied-modules-and-extensions/spi-server-programming-interface-features-examples.md#contrib-spi).
