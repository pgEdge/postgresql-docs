...
| Define options that are specific to this operator class (optional) | 3 |
 ...
 GiST indexes have eleven support functions, six of which are optional, as shown in [GiST Support Functions](#xindex-gist-support-table). (For more information see [GiST Indexes](../../internals/built-in-index-access-methods/gist-indexes.md#gist).)
