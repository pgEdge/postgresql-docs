...
`$args`
:   A Tcl list of the arguments to the function as given in the `CREATE TRIGGER` statement. These arguments are also accessible as `$1` ... <code>$</code><em>n</em> in the function body.
