...
pgBackRest [vdev](https://github.com/pgbackrest/pgbackrest/releases/tag/release/dev) is the current stable release. Release notes are on the [Releases](release.md) page.
