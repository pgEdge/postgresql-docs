...
pgBackRest [vv2.58.0](https://github.com/pgbackrest/pgbackrest/releases/tag/release/v2.58.0) is the current stable release. Release notes are on the [Releases](release.md) page.
...
- [User guides](user-guide/index.md) for various operating systems and PostgreSQL versions.
